...
const TicketMuseumForm = () => {
  ...
  const { dataItems, ticketLoading, success, responseMessages, paymentsUrl, ticketType } = useSelector(
      ...
      dispatch(
        postMuseumTicket({
          ...
          postData: {
            request_name: 'web',
            person,
            items: ticketType.ticketType === 'standart' && respBuyTicket?.obj?.items
                  ...
                  <div className="country_div">
                    {countries.map((value, index) => (
                      <div
                        key={index}
                        onClick={() =>
                          handleChangeCountry(Object.values(value)[0], Object.keys(value)[0])
                        }>
